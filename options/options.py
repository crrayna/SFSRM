    ...
    for phase, dataset in opt['datasets'].items():
        ...
        if dataset.get('dataroot_LQ', None) is not None:
            ...
            if dataset['dataroot_LQ'].endswith('lmdb'):
                is_lmdb = True
        if dataset.get('dataroot_WF', None) is not None:
            dataset['dataroot_WF'] = osp.expanduser(dataset['dataroot_WF'])
            if dataset['dataroot_WF'].endswith('lmdb'):
                is_lmdb = True
